    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-6">
      <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-zinc-400">Welcome back, {userData.name}.</p>
        </div>
        
        {!metrics && (
          <a href="/assessment" className="inline-flex items-center justify-center px-6 py-3 bg-[#CCFF00] hover:bg-[#b3ff00] text-black font-black uppercase tracking-widest text-sm rounded-lg shadow-[0_0_20px_rgba(204,255,0,0.3)] transition-all">
      ...
      {!metrics ? (
        <Card className="p-12 border-zinc-800 bg-zinc-950/50 flex flex-col items-center justify-center text-center">
          ...
          <a href="/assessment" className="inline-flex items-center justify-center px-8 py-4 bg-white hover:bg-zinc-200 text-black font-black uppercase tracking-widest rounded-lg transition-colors">
            Start Assessment
          </a>
        </Card>
      ) : (
